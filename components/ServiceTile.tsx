...
export function ServiceTile({
  ...
  const wash = highlight(VB_W - 26, VB_H - 40, seed + 51);
  ...
  return (
    <button
      ...
      className={[
        "animate-rise group relative flex aspect-[300/180] w-full items-center justify-center",
    ...
    >
      ...
      <div className="relative flex h-full w-full flex-col items-center justify-center gap-[6%] px-[10%] py-[9%]">
        <ServiceMark id={service.id} className="h-[48%] w-auto" />
